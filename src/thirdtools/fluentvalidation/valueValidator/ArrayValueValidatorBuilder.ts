...
export class ArrayValueValidatorBuilder<
	...
	TEachValue,
	TEachTransformedValue extends TEachValue | string | number | boolean | null | undefined | symbol
> {
	private eachValueValidatorBuilder: ValueValidatorBuilder<TModel, TEachValue, TEachTransformedValue>;
	...
	constructor(
		...
		this.eachValueValidatorBuilder = new ValueValidatorBuilder<TModel, TEachValue, TEachTransformedValue>(
			rebuildValidate,
			transformValue
		);
