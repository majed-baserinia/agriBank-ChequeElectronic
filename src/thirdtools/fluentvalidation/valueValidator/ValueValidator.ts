...
import { AsyncRuleValidatorsAndExtensions, RuleValidatorsAndExtensions } from './RuleValidators';
...
export type AsyncBaseValueValidators<TModel, TValue> = BaseValueValidators<TModel, TValue> & {
	mustAsync: (
		definition:
	...
	setAsyncValidator: (
		validatorProducer: (model: TModel) => IAsyncValidator<TValue extends null | undefined ? any : TValue>
	) => AsyncRuleValidatorsAndExtensions<TModel, TValue>;
};

export type StringValueValidators<TModel, TValue extends string | null | undefined> = {
...
export type NumberValueValidators<TModel, TValue extends number | null | undefined> = {
...
export type ObjectValueValidators<TModel, TValue extends object | null | undefined> = {
	setValidator: (
		validatorProducer: (model: TModel) => IValidator<TValue extends null | undefined ? any : TValue>
	) => RuleValidatorsAndExtensions<TModel, TValue>;
};
