				...
				<div className="flex flex-col items-center justify-center p-2">
					...
					<div className="flex w-full justify-between">
						<Typography
							...
							sx={{ marginBottom: "16px", fontWeight: "bold" }}
						>
							{t("chequeReceiptAmount")}
						</Typography>
						<Typography
							variant="bodyMd"
							sx={{ marginBottom: "16px" }}
						>
							{Number(checkInfoPage?.checkAmount).toLocaleString()} {t("rial")}
						</Typography>
					</div>
					<div className="flex w-full justify-between">
						<Typography
							...
							sx={{ marginBottom: "16px", fontWeight: "bold" }}
						>
							{t("chequeReceiptDueDate")}
						</Typography>
						<Typography
							variant="bodyMd"
							sx={{ marginBottom: "16px" }}
						>
							{checkInfoPage?.date.toString()}
						</Typography>
					</div>
					<div className="flex w-full justify-between">
						<Typography
					...
					<div className="flex w-full justify-between">
						<Typography
							...
							sx={{ marginBottom: "16px", fontWeight: "bold" }}
						>
							{t("chequeReceiptAccountNumber")}
						</Typography>
						<Typography
							variant="bodyMd"
							sx={{ marginBottom: "16px" }}
						>
							{selectCheckPage?.selectedAccount}
						</Typography>
					</div>
					<div className="flex w-full justify-between">
						<Typography
							...
							sx={{ marginBottom: "16px", fontWeight: "bold" }}
						>
							{t("chequeReceiptChequeSerialNumber")}
						</Typography>
						<Typography
							variant="bodyMd"
							sx={{ marginBottom: "16px" }}
						>
							{selectCheckPage?.selectedSheet}
						</Typography>
					</div>
					<div className="flex w-full justify-between">
						<Typography
						...
						<Typography
							...
							sx={{ marginBottom: "16px" }}
						>
							{checkInfoPage?.recieverIban || "___"}
						</Typography>
					</div>
					<div className="flex w-full justify-between">
						<Typography
